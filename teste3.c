...
void cabecalho() {
    system("cls");
    printf("==========================================\n");
    printf("      Q U I Z   D A   C O M P U T A C A O \n");
    printf("==========================================\n");
    printf("         .-------------------. \n");
    ...
    do {
        ...
        switch(opcao) {
            case 1:
                ...
                pontuacao += fazerPergunta("Qual funcao imprime na tela?", 
                    "A) scanf", "B) printf", "C) main", 'B');
                
                pontuacao += fazerPergunta("Qual variavel guarda numeros reais?", 
                ...
                pontuacao += fazerPergunta("Qual laco executa PELO MENOS uma vez?", 
                    "A) for", "B) while", "C) do...while", 'C');

                pontuacao += fazerPergunta("O terminador de string e:", 
                    "A) \\0 (Nulo)", "B) \\n (Enter)", "C) %d (Decimal)", 'A');

                pontuacao += fazerPergunta("Onde fica a funcao printf?", 
                ...
                if(pontuacao == 60) printf("       PERFEITO! VOCE E UM MESTRE!\n");
